        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>Saat ini penilaian kinerja mengacu pada SMKBK sehingga lembar ini kami non-aktifkan</p>
                    <?php 
/*
                         ...
                         if($evaluasi[0]->status=='final' ){
                            ...
                            <h4 class="text-center">Unggah File Bukti Kinerja</h4>
                                    ...
                                    <div class="form-group inline">
                                        ...
                                        <input <?=$enablefile?> disabled type="file" class="form-control" name="filekinerja" id="filekinerja">
                                                ...
                                                <?php 
                                                    ...
                                                    switch ($s->formula){
                                                        ...
                                                        case 'P':
                                                            ...
                                                            <input disabled <?=$final?> <?=$disable?> type="number" <?=$jtarget?> class="form-control" name="target[<?=$iurut?>]" value="100">
                                                        ...
                                                        case 'M':
                                                            ...
                                                            <input disabled <?=$final?> <?=$disable?> type="number" <?=$jtarget?> class="form-control" name="target[<?=$iurut?>]">
                                                        ...
                                                        case '0-1':
                                                            ...
                                                            <input disabled <?=$final?> <?=$disable?> <?=$jtarget?> class="form-control" type="number" name="target[<?=$iurut?>]" >
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12 pb-2">
                                            ...
                                            switch ($s->formula){
                                                ...
                                                case 'P':
                                                    ...
                                                    <input disabled <?=$final?> <?=$disable?> type="number" <?=$jreal?> class="form-control" name="realisasi[<?=$iurut?>]" >
                                                ...
                                                case '0-1':
                                                    ...
                                                    <input disabled <?=$final?>  <?=$disable?> <?=$jreal?> class="form-control" type="number" name="realisasi[<?=$iurut?>]" >
                        ...
                        if($evaluasi[0]->status=='final'  && $isatasan){
                           ...
                           // echo $iduserctt."-".$evaluasi[0]->catatan."-".$evaluasi[0]->catatan_dari;
                            ...
                            if($evaluasi[0]->catatan =='' || $evaluasi[0]->catatan_dari=''){
                                ...
                                <textarea disabled class='form-control' name='catatan' rows='8' id='catatan' placeholder='Masukkan catatan untuk bawahan anda'></textarea>
                                ...
                                <textarea disabled readonly class='form-control' name='catatan'  rows='8' id='catatan' placeholder='Masukkan catatan untuk bawahan anda'>".$evaluasi[0]->catatan."</textarea>
                    ...
                    <?php 
                        ...
                        if($evaluasi[0]->status=='final'  && $isatasan==true){
                            ...
                            if($evaluasi[0]->catatan =="" && $evaluasi[0]->catatan_dari!=$iduserctt ){
                                ...
                                echo " <button disabled class='btn btn-primary btn-rounded btnsimpan'> Simpan </button> ";

                                echo "<button disabled class='btn btn-success btn-rounded btnfinal' id='btnfinal'> Simpan Final </button>";
