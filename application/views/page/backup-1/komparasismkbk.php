        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-success" role="alert">
                    ...
                    <ul>
                        <li> <p>Data Kinerja 2021 bersumber pada data penilaian SMKBK tahun 2021.</p></li>
                        <li> <p>Data Kinerja 2022 adalah data hasil inputan pada aplikasi penilaian apel siaga pada evaluasi kinerja.</p></li>
                    </ul>
