                                    ...
                                    <tbody>
                                        <?php 
                                            foreach($rekap as $key=>$val){
                                                 ...
                                                 $persenetos=$etosselesai > 0?round($etosselesai/($tetos)*100,2):0;
                                                 $etosres=$persenetos;
                                                 if($etosres >= 75){
                                                ...
                                                /// 2.Tradisi
                                                $tradisiselesai=isset($val['tradisi']['selesai'])?count((array)$val['tradisi']['selesai']):0;
                                                $tradisikurang=isset($val['tradisi']['kurang'])?count((array)$val['tradisi']['kurang']):0;
                                                $ttradisi=$tradisikurang +$tradisiselesai;
                                                $persentradisi=$tradisiselesai > 0 ?round($tradisiselesai/($ttradisi)*100,2):0;
                                                ...
                                                /// 3.Tritertib
                                                $tritertibselesai=isset($val['tritertib']['selesai'])?count((array)$val['tritertib']['selesai']):0;
                                                $tritertibkurang=isset($val['tritertib']['kurang'])?count((array)$val['tritertib']['kurang']):0;
                                                $ttritertib=$tritertibkurang + $tritertibselesai;
                                                $persentritertib=$tritertibselesai >0?round($tritertibselesai/($ttritertib)*100,2):0;
                                                ...
                                                if($tritertibres >= 75){
                                                 ...
                                                 /// 4. Atribut
                                                 $atributselesai=isset($val['atribut']['selesai'])?count((array)$val['atribut']['selesai']):0;
                                                 $atributkurang=isset($val['atribut']['kurang'])?count((array)$val['atribut']['kurang']):0;
                                                 $tatribut=$atributkurang +$atributselesai;
                                                 $persenatribut=$atributselesai>0?round($atributselesai/($tatribut)*100,2):0;
                                                ...
                                                $totalprogress=((int)$etosres+(int)$tradisires+(int)$tritertibres+(int)$atributres)/4;
                                                if($totalprogress >=75){
                                                ...
                                                echo "<tr>";
                                                echo "<td>".$key."<br>
                                                     ".$totalprogress."% ".$itotal."<br>(tanpa kinerja)
                                                     </td>";
