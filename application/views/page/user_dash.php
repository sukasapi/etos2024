...
$akses=cekakses($_SESSION['logged_in']['perusahaan']);
...
$open=date('Y-m-d H:i:s',strtotime($akses[0]->start_akses));
$lastorder=date('Y-m-d H:i:s',strtotime($akses[0]->end_akses));
                                                    ...
                                                    <div class="card-body">
                                                      <div class="row">
                                                        <?php
                                                           ...
                                                           echo "<div class='col-md-3 col-xs-12 text-center mx-auto'";
                                                        ?>
                                                          
                                                            <form class="fprepare">
                                                                <?php
                                                                $bagian =isset($m->bagian) && $m->bagian!="" ? $m->bagian :"belum diisi";
                                                                $jabatan =isset($m->jabatan) && $m->jabatan!="" ? $m->jabatan :"kosong";
                                                              //echo "<img src='".base_url('assets/img/mitra.png')."' alt='Avatar' class='avatar'>";
                                                                echo "<h5>".ucfirst($m->nama)."</h5><p><strong> ".$m->nopeg."</strong></p>";
                                                                echo "<strong>Bagian | Jabatan</strong>";
                                                                echo "<p><small>".$bagian." | ".$jabatan."</small></p>";
                                                                echo "<strong>Batch</strong>";
                                                                echo "<p ><small> ".$m->batch."</small></p>";
